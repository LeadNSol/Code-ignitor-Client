                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <table id="datatable-buttons1" class="table table-striped table-bordered c_clg">
                      <thead>
                        <tr>                      
                          <th class="c_clg">Contact person</th>
                          <th class="c_clg">Phone no</th>
					  ...
					  ?>
                          <tr id="row<?php echo $value['order_id']?>">
                          ...
                          <td>
						   <div class="Action">
						    <a href="<?php echo base_url()?>more_details/<?php echo $value['order_id']; ?>"> <span class="Action_icon_1"><i class="" aria-hidden="true"></i></span>Details</a>
							</div>
