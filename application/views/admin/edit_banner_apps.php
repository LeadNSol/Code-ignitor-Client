                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                   ...
                   <?php 	
					...
					echo  form_open_multipart('admin_apps/edit_banner_apps/'.$id, $attributes);
					?>
                    <div class="u_p_l_a_img_d">
						<div class="col-sm-12">
							<div class="img_d_sec_bannner">
								 <img class="banner_imgset" src="<?php echo site_base_url();?>uploads/banner_apps/<?php echo @$get_banner[0]['image']?>">
							</div>
						</div>	
                    <input type="hidden" name="old_photo" value="<?php echo @$get_banner[0]['image']?>">						
						...
						<div class="form-group profile_ed_f_rm">
							...
							<div class="col-md-9 col-sm-9 col-xs-12">
							  <textarea  name="deccription" required="required" class="form-control col-md-7 col"><?php echo @$get_banner[0]['description']?></textarea>
							</div>
						  </div>
