               ...
               <table id="datatable-buttons1" class="table table-striped table-bordered c_clg">
					  ...
					  ?>
                        <tr>
                          ...
                          <td><?php echo $val['about_mission']?></td>
                        
							<td><?php echo $val['description']?></td>
							
							  <td><img src="<?php echo site_base_url();?>uploads/gallery/<?php echo $val['img_about']?>" alt="No image" class="dn_im"></td>
                          <td> 
						  <div class="image_name_edit_1" >
								  <a href="edit_about/<?php echo $val['id']?>"><i class="fa fa-pencil" aria-hidden="true"></i></a>
							   </div>
