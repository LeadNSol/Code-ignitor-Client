...
<html lang="en">
  <head>
   ...
   <title> Med Assure</title>
    ...
    <link href="<?php echo base_url(); ?>css/koushik_style.css" rel="stylesheet">
  </head>
			  ...
			  <div class="top">
				  <div class="col-sm-2">
					  <div class="logo_admin">
						  <img src="<?php echo site_base_url();?>uploads/logo/<?php echo $site_logo[0]['logo'];?>" alt="office kitchen">
					  </div>
				  </div>
			  </div>
		  </header>
