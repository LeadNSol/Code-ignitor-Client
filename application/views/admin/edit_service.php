        ...
        <div class="right_col change_ps_w_ord" role="main">
         <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Update <small>Testmonials</small></h2>
                  ...
                  <div class="x_content">
					...
					echo  form_open_multipart('update_about/'.$id, $attributes);
					?>
						...
						<div class="col-md-9 col-sm-9 col-xs-12">
                  <input type="file" name="site_image" multiple required="required" class="form-control col-md-7 col-xs-12" value="<?php echo $image; ?>"/>
