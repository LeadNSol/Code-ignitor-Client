        ...
        <div class="right_col change_ps_w_ord" role="main">        
         <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Update<small>Career</small></h2>
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
                    <br />
                    
               <table id="list_update_career" class="table table-striped table-bordered c_clg">
                      <thead>
                        <tr>                      
					  ...
					  ?>
                        <tr>
						  ...
						  <div class="image_name_edit_1">
								  <a href="edit_career/<?php echo $val['id']?>"><i class="fa fa-pencil" aria-hidden="true"></i></a>
							   </div>
							   <div class="image_name_edit_1">
							          <a href="admin_main/del_career/<?php echo $val['id']?>"  onClick=" return confirm('Are You Sure to Delete order?')"><i class="fa fa-trash-o" aria-hidden="true"></i></a>
							   </div>
						  </td>
					  <?php }?>
					 	</tbody>
