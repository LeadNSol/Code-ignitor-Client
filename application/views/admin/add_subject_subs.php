        ...
        <div class="right_col change_ps_w_ord" role="main">        
         <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Subject<small>Subscription</small></h2>
						...
						if(isset($flash_message)){
						 ...
						 ?>
						  ...
						  <div class="alert alert-success">
							...
							<strong>Well done!</strong>  Subscription added successfully.
						  </div>
								<?php }else { ?>
                  ...
                  <div class="x_content">
					...
					echo  form_open_multipart('add_subject_subs_details/', $attributes);
					?>
					<input type="hidden"  name="user_id" placeholder='User Id' value="<?php echo $student_id;?> " >
		              ...
		              <div class="col-md-9 col-sm-9 col-xs-12">
		                  <select class="form-control col-md-7 col-xs-12" name="class_id" required="required" id="pack_id">
