        ...
        <div class="right_col change_ps_w_ord" role="main">        
         <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Add <small>Testmonials</small></h2>
						...
						if(isset($flash_message)){
						 ...
						 ?>
						  ...
						  <div class="alert alert-success">
							...
							<strong>Well done!</strong>  add Testmonials successfully.
						  </div>
								<?php }else { ?>
                  ...
                  <div class="x_content">
					...
					echo  form_open_multipart('add_term_details/', $attributes);
					?>
						...
						<div class="col-md-9 col-sm-9 col-xs-12">
						     <input type="text" id="facebook_link" name="title" required="required" class="form-control col-md-7 col-xs-12" value="">
						</div>
				       </div>
					    <div class="form-group profile_ed_f_rm">
