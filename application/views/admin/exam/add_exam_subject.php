              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
						...
						if(isset($flash_message)){
						 ...
						 ?>
						  ...
						  <div class="alert alert-success">
							...
							<strong>Well done!</strong>  add exam Subject successfully.
						  </div>
								<?php }else { ?>
                  ...
                  <div class="x_content">
					...
					echo  form_open_multipart('add_exam_subject_details/', $attributes);
					?>
		              ...
		              <div class="col-md-9 col-sm-9 col-xs-12">
		               ...
		               <div class="form-group profile_ed_f_rm">
						...
						<div class="col-md-9 col-sm-9 col-xs-12">
						     <input type="text" id="amount" name="amount" required="required" class="form-control col-md-7 col-xs-12" value="">
						</div>
				       </div>
				<div class="form-group profile_ed_f_rm">
						...
						<div class="col-md-9 col-sm-9 col-xs-12">
						     <input type="number" id="duration" name="duration" required="required" class="form-control col-md-7 col-xs-12" value="">
						</div>
				       </div>
