          ...
          <div class="row">
           ...
           <?php
            ...
            ?>
                          ...
                          <td>
               <div class="Action">
                <a href="<?php echo base_url()?>edit_user/<?php echo $value['u_id']; ?>"><span class="Action_icon_1"><i class="fa fa-pencil" aria-hidden="true"></i></span></a>
              <a href="<?=site_url("")?>delete_user/<?php echo $value['u_id']?>"  onClick=" return confirm('Are You Sure to Delete order?')"><i class="fa fa-trash-o" aria-hidden="true"></i></a>
               </div>
               </td>      
                  </tr>
            <?php }?>
