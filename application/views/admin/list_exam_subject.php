                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered c_clg">
                      <thead>
                        <tr>                      
                          ...
                          <th class="c_clg">Exam Subject</th>
					  ...
					  ?>
						  ...
						  <td><?php echo $value['amount']; ?></td>
                           <td><img src="<?php echo site_base_url();?>images/<?php echo $value['image']?>"  height="100px" width="200px"></td>
                          <td>
						   <div class="Action">
						    <a href="<?php echo base_url()?>edit_exam_subject/<?php echo $value['s_id']; ?>"><span class="Action_icon_1"><i class="fa fa-pencil" aria-hidden="true"></i></span></a>
							<a href="<?=site_url("")?>delete_exam_subject/<?php echo $value['s_id']?>"  onClick=" return confirm('Are You Sure to Delete order?')"><i class="fa fa-trash-o" aria-hidden="true"></i></a>
						   </div>
						   </td>      
                  </tr>
					  <?php }?>
