         ...
         <div class="row">
            ...
            if(isset($flash_message)){
             ...
             ?>
              ...
              <strong>Well done!</strong>  add Privacy successfully.
              </div>
                <?php }else { ?>
                 ...
                 <?php } } ?> 
                  <div class="x_content">
					...
					echo  form_open_multipart('add_privacy_details/', $attributes);
					?>
                      ...
                      <div class="form-group profile_ed_f_rm">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <input type="text" id="admin_email" name="title" required="required" class="form-control col-md-7 col-xs-12" value="">
                        </div>
                      </div>  
					   <div class="form-group profile_ed_f_rm">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <textarea rows="3" cols="50" class="form-control col-md-7 col-xs-12  ckeditor" name="description"></textarea>
                        </div>
                      </div>
                  <!-- <div class="form-group profile_ed_f_rm">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <input type="file" id="icon" name="site_image" required="required" class="form-control col-md-7 col-xs-12" value="" required="required">
