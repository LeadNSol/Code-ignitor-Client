                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                   ...
                   // $user_id=1;				   
					...
					echo  form_open_multipart('edit_news/'.$id, $attributes);
					?>
                       <div class="form-group profile_ed_f_rm">
							...
							<div class="col-md-9 col-sm-9 col-xs-12">
							  <input type="text"  name="title" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo @$edit_news[0]['title']?>">
							</div>
						  </div>
						...
						<div class="form-group profile_ed_f_rm">
							...
							<div class="col-md-9 col-sm-9 col-xs-12">
							  <input type="text"  name="description" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo @$edit_news[0]['description']?>">
							</div>
						  </div>   
						  ...
						  <div class="form-group profile_ed_f_rm">
							...
							<div class="col-md-9 col-sm-9 col-xs-12">
							 <input type="file" id="offer_image" class="form-control col-md-7 col-xs-12" name="banner_img">
							  ...
							  <img src="<?php echo site_base_url();?>uploads/gallery/<?php echo @$edit_news [0]['image'] ?>"height="150px" width="200px">
							  <input type="hidden" value="<?php echo @$edit_news [0]['image'] ?>" name="old_photo">
							</div>
						  </div>
