              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
						...
						if(isset($flash_message)){
						 ...
						 ?>
						  ...
						  <div class="alert alert-success">
							...
							<strong>Well done!</strong>  add Model successfully.
						  </div>
								<?php }else { ?>
                  ...
                  <div class="x_content">
					...
					echo  form_open_multipart('edit_exterior_image/', $attributes);
					?>
					   ...
					   <div class="form-group profile_ed_f_rm">
						...
						<div class="col-md-9 col-sm-9 col-xs-12">
						     <input type="file" id="facebook_link" name="model_name" required="required" class="form-control col-md-7 col-xs-12" value="">
						</div>
				       </div>   
