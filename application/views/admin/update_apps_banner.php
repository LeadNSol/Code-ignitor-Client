               ...
               <table id="datatable-buttons1" class="table table-striped table-bordered c_clg">
					  ...
					  ?>
                        <tr>
                          ...
                          <td><img src="<?php echo site_base_url();?>uploads/banner_apps/<?php echo $val['image']?>" alt="No image" class="dn_im"></td>
                          <td><?php echo $val['description']?></td>
                          <td> 
						  <div class="image_name_edit_1">
								  <a href="edit_banner_apps/<?php echo $val['id']?>"><i class="fa fa-pencil" aria-hidden="true"></i></a>
							   </div>
							   <div class="image_name_edit_1">
							          <a href="delete_banner/<?php echo $val['id']?>"><i class="fa fa-trash-o" aria-hidden="true"></i></a>
							   </div>
						  </td>
					  <?php }?>
