...
<div class="right_col" role="main">        
          ...
          <input type="hidden" value="<?php echo $value['u_id']; ?>" id="u_id">
                          ...
                          <td><?php echo $value['email']; ?></td>
                           <!--<td>
            <?php $result=$this->product_module->fetch_packages($value['u_id']);
                            //print_r($result);
                            
            foreach($result as $key=>$pack)
            {
               echo $packname=$pack['pack_name'];
            }   
            ?>
 ...
 <button type="button" class="btn btn-success" onclick="window.location.href='<?php echo base_url()?>add_subject_subs/<?php echo $value['u_id']; ?>'">Add </button>
